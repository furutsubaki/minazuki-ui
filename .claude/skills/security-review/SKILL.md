...
metadata:
    ...
    github-tree-sha: 80ef539ccdcaf4814db35819b3ffcb530d176332
---
# security-review
...
2. **`./security-reports/index.md` に1行追記する**
   ...
   - 追記フォーマット:
   ```
   | YYYY-MM-DD | security-review | <ブランチ名> | <変更ファイル数>ファイル | 0 | <High件数> | <Medium件数> | <CI結果> | [レポート](YYYY-MM-DD-security-review.md) |
   ```
